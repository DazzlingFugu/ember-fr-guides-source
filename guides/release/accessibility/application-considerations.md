...
- [ember-gestures](https://github.com/html-next/ember-gestures) - Ember Gestures fournit un a moyen simple d'utiliser les interactions tactiles en facilitant la définition et l'utilisation de contrôleurs HammerJS dans une application.
...
Bien qu'il y ait beaucoup de notions à prendre en compte et à connaître, voici un aide-mémoire pour vous aider à commencer : [Aide-memoire Accessibilité](https://moritzgiessmann.de/accessibility-cheatsheet/)
